#
#  Be sure to run `pod spec lint HEERONCategory.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Zhang Hailing"
  # s.authors            = { "Zhang Hailing" => "zhanghl@lansejuli.com" }
  # s.social_media_url   = "http://twitter.com/Zhang Hailing"
